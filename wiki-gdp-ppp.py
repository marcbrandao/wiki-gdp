...
for country_name, url in country_urls:
    ...
    try:
        ...
        for table in tables:
            ...
            if any(('US$PPP' in cell.text or 'US$ PPP' in cell.text) and 'per capita' not in cell.text for cell in header_cells):
                ...
                gdp_col_index = next((i for i, cell in enumerate(header_cells) 
                                      if ('US$PPP' in cell.text or 'US$ PPP' in cell.text) 
